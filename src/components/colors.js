...
export default {
  colors: {
    ...
    'activityBarTop.activeBackground': colors.backgroundDarker,
    'activityBarTop.activeBorder': colors.selectionLight,
    'activityBarTop.background': colors.backgroundDarker,
    'activityBarTop.dropBorder': colors.backgroundDarker,
    ...
    'sideBarActivityBarTop.border': colors.backgroundDarker,
    ...
    'sideBarTitle.background': colors.backgroundDarker,
    'sideBarTitle.border': colors.backgroundDarker,

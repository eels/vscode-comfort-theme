...
export default {
  tokenColors: [
    ...
    {
      name: 'java modifier.import',
      scope: ['storage.modifier.import.java', 'storage.type.generic.java', 'storage.type.java'],
      settings: {
        foreground: colors.yellow,
      },
    },
    ...
    },
    {
      ...
      scope: ['keyword.operator.css', 'keyword.operator.less', 'keyword.operator.scss'],
      settings: {
        foreground: colors.cyan,
      },
    },
    ...
    {
      name: 'js/ts module',
      scope: ['support.module.node', 'support.module.node', 'support.type.object.module'],
      settings: {
        foreground: colors.yellow,
      },
    },
    ...
    },
    {
      ...
      scope: ['string.other.link.description.markdown', 'string.other.link.title.markdown'],
      settings: {
        foreground: colors.blue,
      },
    },
    ...
    },
    {
      ...
      scope: ['meta.function.decorator.identifier.python', 'support.token.decorator.python'],
      settings: {
        foreground: colors.cyan,
      },
    },
    ...
    {
      name: 'comment',
      scope: ['comment', 'comment.block.documentation', 'comment.line.double-slash'],
      settings: {
        fontStyle: 'italic',
      },
    },
